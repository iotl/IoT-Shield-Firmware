...
class Scheduler
{
	public:
		 ...
		 */
		bool addTask(Task * task, unsigned long timer, void * data = 0, bool reshot = true);
    ...
    */
     ...
     */
    inline void setTask(unsigned char index, Task * task, unsigned long int timer, unsigned long int timestamp, void * data, bool reshot);
